...
from models_cpulstm import CNNBLSTMCalssifier_cpulstm
...
logdir = 'librispeech_cpulstm_log_dir'
model_dir = 'librispeech_cpulstm_ckpt_model_dir'
restore_dir = 'librispeech_cpulstm_ckpt_model_dir'
...
def main():
    ...
    # 调用模型
    classifier = CNNBLSTMCalssifier_cpulstm(out_dims=PPG_DIM, n_cnn=3, cnn_hidden=256,
