...
# out1
ppg_dir = './LJSpeech-1.1-English-PPG/ppg_generate_10ms_by_audio_hjk2'
mfcc_dir = './LJSpeech-1.1-English-PPG/mfcc_10ms_by_audio_hjk2'
mel_dir = './LJSpeech-1.1-English-PPG/mel_10ms_by_audio_hjk2'
spec_dir = './LJSpeech-1.1-English-PPG/spec_10ms_by_audio_hjk2'
rec_wav_dir = './LJSpeech-1.1-English-PPG/rec_wavs_16000'
...
# out2
good_meta_path = './LJSpeech-1.1-English-PPG/meta_good.txt'
f_good_meta = open(good_meta_path, 'w')

# NN->PPG
ckpt_path = './librispeech_ckpt_model_dir/librispeechASR.ckpt-94000'
