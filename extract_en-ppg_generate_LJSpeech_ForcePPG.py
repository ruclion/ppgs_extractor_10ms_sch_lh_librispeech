...
# out1  
ppg_dir = './EN-PPG_ljspeech/ppg_ForcePPG'
mfcc_dir = './EN-PPG_ljspeech/mfcc_ForcePPG'
mel_dir = './EN-PPG_ljspeech/mel_ForcePPG'
spec_dir = './EN-PPG_ljspeech/spec_ForcePPG'
rec_wav_dir = './EN-PPG_ljspeech/rec_wavs_ForcePPG'
...
# out2
out_meta_path = './EN-PPG_ljspeech/meta_list_ForcePPG.txt'
