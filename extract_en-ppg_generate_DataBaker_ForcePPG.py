...
# out1   
ppg_dir = './EN-PPG_databaker/ppg_ForcePPG'
mfcc_dir = './EN-PPG_databaker/mfcc_ForcePPG'
mel_dir = './EN-PPG_databaker/mel_ForcePPG'
spec_dir = './EN-PPG_databaker/spec_ForcePPG'
rec_wav_dir = './EN-PPG_databaker/rec_wavs_ForcePPG'
...
# out2
out_meta_path = './EN-PPG_databaker/meta_list_ForcePPG.txt'
